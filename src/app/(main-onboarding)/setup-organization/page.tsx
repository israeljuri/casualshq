import { OrganizationForm } from '@/features/(main-onboarding)/components/OrganizationForm';

import { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Set Up Your Organization | TimerX',
  description: 'Configure your business details to customize TimerX for your organization and ensure accurate time tracking and payroll management.',
};
