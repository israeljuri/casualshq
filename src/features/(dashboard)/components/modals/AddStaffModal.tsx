...
//   isOpen: boolean;
//   onClose: () => void;
//   onSubmit: (data: StaffFormData) => Promise<void>; // Changed to StaffFormData
...
//         teamRatePerHour: undefined, // Ensure it's undefined initially for the placeholder
//         awardRatePerHour: undefined, // Ensure it's undefined initially for the placeholder
//       },
//     },
//   });

//   const selectedWageType = watch('wageDetails.type');
...
//         wageDetails: {
//           type: initialData.wageDetails?.type || 'manual',
//           manualRatePerHour:
...
//           teamRatePerHour: undefined,
//           awardRatePerHour: undefined,
//         },
//       });
//     }
...
//       wageDetails: {
//         type: data.wageDetails.type,
//         manualRatePerHour:
//           data.wageDetails.type === 'manual'
//             ? data.wageDetails.manualRatePerHour
//             : undefined,
//       },
//     };
...
//                 )}
//               />
//               {errors.wageDetails?.type && (
//                 <p className="text-xs text-red-500 mt-1">
//                   {errors.wageDetails.message}
//                 </p>
//               )}
//             </div>
...
//                     type="number"
//                     step="0.01"
//                     {...register('wageDetails.manualRatePerHour')}
//                     className="mt-1 h-10 border-slate-300"
//                     placeholder="e.g. 25.50"
//                   />
//                   {errors.wageDetails?.manualRatePerHour && (
//                     <p className="text-xs text-red-500 mt-1">
//                       {errors.wageDetails.manualRatePerHour.message}
//                     </p>
//                   )}
//                   {/* Catch-all for the refine error */}
//                   {errors.wageDetails?.root &&
//                     !errors.wageDetails?.manualRatePerHour && (
//                       <p className="text-xs text-red-500 mt-1">
//                         {errors.wageDetails.root.message}
//                       </p>
//                     )}
//                 </div>
//               </div>
