...
const variantStyles: Record<AlertVariant, { bg: string; iconContainerBg?: string; titleColor: string; subtextColor: string; iconColor: string; borderColor: string }> = {
  success: {
...
const Alert: React.FC<AlertProps> = ({
  ...
  const iconContainerClasses = "bg-white rounded-full flex w-[3rem] h-[3rem] items-center justify-center"; // Adjusted for direct icon display, mr-4 for gap
